...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        //입력 데이터 준비
        {
            ...
            //예상하기
            Article article = new Article(4L, "당신의 인생영화?", "댓글 ㄱ");
    ...
    void findByNickname() {
        /* Case 1: "Park"의 모든 댓글 조회 */
        {
            ...
            // 예상
            Comment a = new Comment(1L, new Article(4L, "당신의 인생영화?", "댓글 ㄱ"), nickname, "굳 윌 헌팅");
        ...
        /* Case 2 : "Kim" 의 모든 댓글 조회*/
        {
            ...
            List<Comment> comments = commentRepository.findByNickname(nickname);
            // 예상
            Comment a = new Comment(2L, new Article(4L, "당신의 인생영화?", "댓글 ㄱ"), nickname, "아이 엠 샘");
